...
namespace MyOpCodes.Extension
{
    ...
    [ExportToolBarButton(Icon = DsImagesAttribute.Assembly, ToolTip = "Open .Net OpCodes",
        Group = TBConstants.GROUP_APP_TB_EXTENSION, Order = 0)]
    sealed class TBCommand1 : ToolBarButtonBase
    {
        public override void Execute(IToolBarItemContext context) => Parallel.Invoke(() =>
        {
            new Myform().Show();
        });
    }
